...
- из 1185 правил запуска процессов Windows загружаются 1184, это пока
  единственный сопоставленный источник;
- все 276 регрессионных случаев SigmaHQ для загружаемых правил срабатывают
